...
#+END_SRC
=originalData= et =other= sont *identiques* entre elles et seulement *égales* à =another=.
...
#+END_SRC
=customer= et =other= sont *identiques* entre elles et seulement *égales* à =another=.
Comment tester l'égalité ?
...
Pour construire un nouvel objet qui est une copie, il est
conventionnel d'utiliser une méthode =clone=.
...
En fait, on utilise souvent [[https://www.artima.com/intv/bloch13.html][un constructeur par copie]].
